...
<head>
    ...
    <title>Edição de Inquilino</title>
...
<body class="container" bgcolor="white" >
    <div class="jumbotron jumbotron-fluid">
        <div class="container">
            <h2 class="display-4">Editar Inquilino</h2>
        </div>
        <div class="row">
            <form action="editarInquilino.php" method="POST" id="frmEditarInquilino"
                  name="frmEditarInquilino" class="col s12"> 
