...
<body class="container" bgcolor="white" >
    <div class="jumbotron jumbotron-fluid">
        <div class="container">
            <h1 class="display-4">Remover Imovel</h1>
        </div>
    </div>
    
    <form action="removerImovel.php" method="POST" id="frmRemoverImovel"
                  name="frmRemoverImovel" class="col s12"> 
    <input type="hidden" class="form-control" id="id" name="id" value="<?php echo $Imovel_ID;?>">
        <div class="form-row" >
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control"  placeholder="Situacao_locacao" name="Situacao_locacao" value="<?php echo $Situacao_locacao;?>">
        </div>
